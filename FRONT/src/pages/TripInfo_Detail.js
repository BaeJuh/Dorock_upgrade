    ...
    return (
        <div className={styles.wrapper}>
            ...
            {touristSpotData !== null ?
                <>
                    <div className={styles.titleBox}>
                        <h2>상세보기<i className="xi-angle-right"></i> {touristSpotData["title"]}</h2>
                    </div>
                    <section className={styles.detailWrapper}>
                        {/* ====== */}
                        <article className={styles.boxes}>
                            {touristSpotData["firstimage"] === "" ?
                                <div className={styles.noImage} style={{ backgroundImage: `url(${noImage})` }}></div>
                                : <div className={styles.image} style={{ backgroundImage: `url(${touristSpotData["firstimage"]})` }}></div>
                            }
                        ...
                        <article className={styles.commentBox}>
                            <div className={styles.infoArea}>
                                <p className={styles.title}>{touristSpotData["title"]}</p>
                    ...
                    <Chatroom title={touristSpotData["title"]}></Chatroom>
                    ...
                    <YoutubeVideo title={touristSpotData["title"]}></YoutubeVideo>
